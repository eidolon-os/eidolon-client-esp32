...
CONFIG_EIDOLON_ATK_OWNER_FACE_TEST=y
CONFIG_EIDOLON_ATK_OWNER_FACE_SAMPLE_INTERVAL_MS=1500
...
sync_existing_sdkconfig() {
  ...
  set_sdkconfig_value CONFIG_EIDOLON_ATK_OWNER_FACE_TEST y
  set_sdkconfig_value CONFIG_EIDOLON_ATK_OWNER_FACE_SAMPLE_INTERVAL_MS 1500
}
