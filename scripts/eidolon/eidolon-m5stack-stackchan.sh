...
# Board defaults
# ---------------------------------------------------------------------------
readonly BOARD_PATH="m5stack-stackchan"
readonly BOARD_NAME="m5stack-stackchan"
readonly BOARD_TARGET="esp32s3"
readonly BOARD_KCONFIG="CONFIG_BOARD_TYPE_M5STACK_STACKCHAN=y"
readonly PARTITION_CSV="partitions/v2/16m_eidolon.csv"
readonly FLASH_SIZE="16MB"
readonly MONITOR_BAUD="115200"
readonly SDK_MARKER="# Append by eidolon-m5stack-stackchan.sh"
readonly SCRIPT_LABEL="eidolon-m5stack-stackchan"
...
# M5Stack CoreS3 camera: GC0308 0.3MP over DVP (matches board config.json)
...
show_banner() {
  ...
  echo "============================================================"
  echo "  Eidolon 开发工具"
  echo "  硬件: M5Stack CoreS3 (StackChan body)"
  echo "============================================================"
