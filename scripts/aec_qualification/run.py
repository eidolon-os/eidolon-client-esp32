...
def write_overlay(board: BoardVariant, out_dir: Path, box_ref_channel: int | None = None) -> Path:
...
def build_firmware(
    ...
    overlay = write_overlay(board, out_dir, box_ref_channel)
...
def main() -> int:
    ...
    if not args.skip_build:
        build_firmware(board, build_dir, out_dir, args.box_ref_channel)
    if args.build_only:
